  ...
  return (
    <div className='footer-container'>
        ...
        <div className='footer-item'>
            <a className='footer-link footer-format' href='https://creativecommons.org/licenses/by-nc-sa/4.0/'><img id="footer-CC-image" src='./images/cc_thumbnail_by-nc-sa.png' style='width:100px' alt='Attribution-NonCommercial-ShareAlike 4.0 International'/></a>
        </div>
